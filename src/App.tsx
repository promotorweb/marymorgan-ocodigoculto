...
export default function App() {
  return (
    <main className="relative bg-[#0A0A0A] text-[#F5F5F5]">
      {/* BOTÃO CENTRAL DO PDF */}
      <div className="absolute left-1/2 top-8 z-50 flex -translate-x-1/2 flex-col items-center gap-3 text-center">
        <a
          href="/Mary-Morgan-O-Codigo-Oculto.pdf"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Baixar Ebook em PDF"
          className="
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="animate-bounce text-2xl leading-none text-[#C8A96A]">
            ↓
          </span>
        </div>
      </div>
      ...
      <div id="ebook-root">
        ...
        <Page number={2} total={TOTAL} chapter="Capítulo 01" variant="dark">
        ...
        <Page number={20} total={TOTAL} chapter="Conclusão" variant="dark">
